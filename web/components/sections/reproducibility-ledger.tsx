...
export function ReproducibilityLedger() {
  ...
  return (
    <section className="repro-section is-paper-anchor-right" id="repro" data-paper-stage="repro" data-paper-hide>
      <Reveal>
      ...
      <div className="repro-grid">
        <Reveal>
          <div>
            ...
            <p className="mono" style={{ marginTop: 16 }}>RECEIPT · {rows.length} ROWS</p>
          </div>
        </Reveal>
